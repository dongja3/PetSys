...
<title><bean:message key="pet.statResultByVariety" /></title>
</head>
<body>
...
<table width="96%" border="0" align="center" cellpadding="0"
	...
	<tr>
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td width="100%" colspan="4" class="tdtitle"><bean:message
									key="pet.statResultByVariety" /></td>
							</tr>
							<tr class="bggray">
		...
		<input type="hidden" id="pageURL"
			value="statResultShow.do?method=statByVariety" /> <input
			type="hidden" id="params"
			value='<bean:write name="params" filter="false"/>' /><html:button
