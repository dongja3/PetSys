...
<title><bean:message key="error.page.illegal.title" /></title>
...
<table width="96%" border="0" align="center" cellpadding="0"
	...
	<tr>
		...
		<div align="center"><img src="image/error.jpg"></div>
		</td>
		<td width="75%">
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0"
			...
			<tr>
				<td class="tdtitle"><bean:message key="error.page.illegal.title" /></td>
			</tr>
			<tr>
				<td><br>
				<br>
				<br>
				<br>
				<bean:message key="error.page.illegal" /><br>
				<br>
				<br>
				<br>
				</td>
